...
class Connection {
	...
	public static function is_connection_requested() {
		$maybe_leadin_connect = QueryParams::get_param( self::CONNECT_NONCE_ARG, 'hubspot-nonce', self::CONNECT_NONCE_ARG );
	...
	public static function is_disconnection_requested() {
		$maybe_leadin_disconnect = QueryParams::get_param( self::DISCONNECT_NONCE_ARG, 'hubspot-nonce', self::DISCONNECT_NONCE_ARG );
	...
	public static function oauth_connect() {
		$connect_params = QueryParams::get_parameters( self::CONNECT_KEYS, 'hubspot-nonce', self::CONNECT_NONCE_ARG );
